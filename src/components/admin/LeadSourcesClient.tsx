...
export function LeadSourcesClient({ initialSources, collegeId, adminId, initialSourceStats }: Props) {
  ...
  const maxTotal = Math.max(...sourcesWithData.map((s) => getStat(s.id)?.total || 0), 1)
